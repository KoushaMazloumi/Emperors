...
/**
 * Generates map pieces of different shapes and colors
 */
export class MapPieceGenerator {
  ...
  static generateRandomColor(colorIndices) {
    return MAP_PIECE_COLORS[colorIndices.pop()];
  }
  ...
  createPieceShape() {
    ...
    this.generatedPieceCount++;
    return shape;
  }
}

/**
 * Represents a map piece that can be placed on the board
 */
...
/**
 * Rotates map pieces 90 degrees clockwise
 */
